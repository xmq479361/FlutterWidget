...
class DateTimeFormatter {
  ...
  static String generateDateFormat(
    ...
    switch (pickerMode) {
      ...
      case DateTimePickerMode.datetime_support:
        return DATETIME_PICKER_DATETIME_EXTEND_FORMAT;
    }
    return '';
  }
  ...
  static List<String> _getWeeksFull() {
    return [
      "星期一",
      "星期二",
      "星期三",
  ...
  static List<String> _getWeeksShort() {
    return [
      "周一",
      "周二",
      "周三",
